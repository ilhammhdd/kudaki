...
import (
	...
	"github.com/ilhammhdd/kudaki-recommendation-service/externals"
...
func main() {
	...
	wp.Worker <- new(externals.AddRecommendationGear)
	wp.Worker <- new(externals.RetrieveRecommendationGear)
	wp.Worker <- new(externals.RetrieveRecommendedGearItems)
